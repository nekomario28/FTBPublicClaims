    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("publicclaim")
                ...
                .then(Commands.literal("settings")
                        .then(booleanSetting("pvp", PublicClaimCommand::setPvp))
                        .then(booleanSetting("explosions", PublicClaimCommand::setExplosions))
                        .then(booleanSetting("mob_griefing", PublicClaimCommand::setMobGriefing)))
